        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1"
                    data-aos="fade-up">
                    <div>
                        <h1 class="text-warning">Hobbest - Hobbies<br> &emsp;&emsp;&emsp;&emsp; Interests<br> &emsp;&emsp;&emsp; Passions</h1>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-4 box" data-aos="fade-right">
                        ...
                        <ul>
                            ...
                            <li class="na"><i class="bx bx-x"></i> <span>Nulla at volutpat diam
                                    uteera</span></li>
                        ...
                        <a href="#" class="get-started-btn">Register now</a>
                    </div>
                    ...
                    <div class="col-lg-4 box featured" data-aos="fade-up">
                        ...
                        <a href="#" class="get-started-btn bg-warning">Get Started</a>
                    </div>
                    ...
                    <ul>
                        <li data-aos="fade-up">
                            <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse"
                                class="collapse" data-bs-target="#accordion-list-1">Non consectetur a erat nam at
                        ...
                        <li data-aos="fade-up" data-aos-delay="100">
                            <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse"
                                data-bs-target="#accordion-list-2" class="collapsed">Feugiat scelerisque varius
                        ...
                        <li data-aos="fade-up" data-aos-delay="300">
                            <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse"
                                data-bs-target="#accordion-list-4" class="collapsed">Tempus quam pellentesque nec
