                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3" id="gender">
                                        ...
                                        <select class="form-select" id="gender" name="gender">
                                            ...
                                            <option class="@error('gender_diff') is-invalid @enderror" value="male">Male</option>
                                            <option class="@error('gender_diff') is-invalid @enderror" value="female">Female</option>
                                        </select>
                                    </div>
                                    @error('gender_diff')
                                        <span class="invalid-feedback" role="alert">
