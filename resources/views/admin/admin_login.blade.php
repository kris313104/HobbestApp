...
<head>
    ...
    <meta name="keywords"
        content="Hobbest, dating app, best dating app" />
    <meta name="description" content="Hobbest Admin" />
    <meta name="robots" content="noindex,nofollow" />
    <title>Hobbest Admin</title>
    <!-- Favicon icon -->
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="pt-3">
                                        ...
                                        <input class="btn btn-success float-end text-white" type="submit"
                                            value="Login" />
                                    </div>
                                </div>
                            </div>
